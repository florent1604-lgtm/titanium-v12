...
| `ARCHITECTURE.md` | Full data flow, module table, async loops |
| `COMMANDES.txt` | All CLI commands, troubleshooting, setup guide |
| `docs/` | Walk-forward validation logs + future research notes (spectral roadmap to be recreated) |
